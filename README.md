...
Or, get specifically the flaming rx EF's
...
following example illustrates use of ./bin/fccs2ef for a wild fire (the default
fire type), but as with the classes described above, the usage of ./bin/ct2ef
...
to get the EF for flaming/smoldering rx CO2:
    ...
    $ ./bin/fccs2ef 10 -p flaming -s CO2
    {"10": {"flaming": 3200.0}}
