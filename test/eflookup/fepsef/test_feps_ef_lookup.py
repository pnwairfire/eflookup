...
class TestLookup:
    ...
    def test_without_haps(self):
        assert WITHOU_HAPS == FepsEFLookup()
        assert WITHOU_HAPS == FepsEFLookup(include_haps=False)
    ...
    def test_get(self):
        ...
        assert WITH_HAPS == lu.get()
        assert WITH_HAPS['flaming'] == lu.get(phase='flaming')
        assert WITH_HAPS['flaming']['CO'] == lu.get(phase='flaming', species='CO')
    ...
    def test_getitem(self):
        ...
        assert WITH_HAPS['flaming'] == lu['flaming']
        assert WITH_HAPS['flaming']['CO'] == lu['flaming']['CO']

    def test_modifying_efs_does_not_affect_class_copy(self):
        lu = FepsEFLookup()
        lu = {'dsf':123}
        assert FepsEFLookup.EFS_NO_HAPS == WITHOUT_HAPS
